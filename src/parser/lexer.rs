...
fn lexer<'src>(
    ...
    let keyword = choice((
        ...
        text::ascii::keyword("if").to(Token::If),
        text::ascii::keyword("else").to(Token::Else),
        text::ascii::keyword("when").to(Token::When),
        text::ascii::keyword("in").to(Token::In),
        text::ascii::keyword("out").to(Token::Out),
        text::ascii::keyword("is").to(Token::Is),
        text::ascii::keyword("as").to(Token::As),
        text::ascii::keyword("true").to(Token::True),
        text::ascii::keyword("false").to(Token::False),
        text::ascii::keyword("null").to(Token::Null),
        text::ascii::keyword("return").to(Token::Return),
        text::ascii::keyword("break").to(Token::Break),
        text::ascii::keyword("continue").to(Token::Continue),
        text::ascii::keyword("throw").to(Token::Throw),
        text::ascii::keyword("this").to(Token::This),
        text::ascii::keyword("super").to(Token::Super),
    ));
